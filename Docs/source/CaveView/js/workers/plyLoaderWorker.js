(function (factory) {
	...
	const LINEAR_SRGB_TO_LINEAR_DISPLAY_P3 = new Matrix3$1().fromArray( [
		0.8224621, 0.0331941, 0.0170827,
		0.1775380, 0.9668058, 0.0723974,
		- 0.0000001, 0.0000001, 0.9105199
	] );

	const LINEAR_DISPLAY_P3_TO_LINEAR_SRGB = new Matrix3$1().fromArray( [
	...
	*/
	...
	let Object3D$1 = class Object3D extends EventDispatcher$1 {
		...
		getWorldScale( target ) {
			...
			this.matrixWorld.decompose( _position$3, _quaternion$2$1, target );
	...
	class Color {
		...
		getHex( colorSpace = SRGBColorSpace ) {
			...
			return clamp$1( _color$1.r * 255, 0, 255 ) << 16 ^ clamp$1( _color$1.g * 255, 0, 255 ) << 8 ^ clamp$1( _color$1.b * 255, 0, 255 ) << 0;
	...
	const UniformsLib = {
		...
		common: {
			...
			uv2Transform: { value: /*@__PURE__*/ new Matrix3$1() },
